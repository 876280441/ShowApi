...
$api->version('v1', ['middleware' => 'api.throttle', 'limit' => 20, 'expires' => 1], function ($api) {
    ...
    $api->group(['prefix' => 'auth'], function ($api) {
        ...
        //通过邮箱找回密码--获取验证码
        $api->patch('reset/password/email/code', [\App\Http\Controllers\Auth\PasswordResetController::class, 'emailCode']);
        //提交邮箱和验证码去修改密码
        $api->patch('reset/password/email/update', [\App\Http\Controllers\Auth\PasswordResetController::class, 'resetPasswordByEmail']);
